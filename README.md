...
项目当前使用 Expo SDK 56。开始改代码前请先查看版本化文档：<https://docs.expo.dev/versions/v56.0.0/>。当前依赖组合为 Expo `~56.0.8`、React Native `0.85.3`、React `19.2.3`、TypeScript `~6.0.3`；Expo 56 文档要求的最低 Node.js 版本为 `22.13.x`。
...
- 备份包包含 SQLite 数据库、`manifest.json` 和应用文档目录中的自定义素材，例如表情包、头像、背景、图标、共读导入文件和封面。
